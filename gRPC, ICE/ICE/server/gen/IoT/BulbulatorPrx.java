...
public interface BulbulatorPrx extends DevicePrx
{
    default void doNothing()
        throws EX
    {
        doNothing(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void doNothing(java.util.Map<String, String> context)
        throws EX
    {
        try
        {
            _iceI_doNothingAsync(context, true).waitForResponseOrUserEx();
        }
        catch(EX ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<Void> doNothingAsync()
    {
        return _iceI_doNothingAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> doNothingAsync(java.util.Map<String, String> context)
    {
        return _iceI_doNothingAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_doNothingAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "doNothing", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_doNothing);
        f.invoke(true, context, null, null, null);
        return f;
    }

    /** @hidden */
    static final Class<?>[] _iceE_doNothing =
    {
        EX.class
    };
